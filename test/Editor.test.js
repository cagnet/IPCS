...
test('les cinq bornes du transformateur suivent sa rotation',()=>{const editor=editorStub();editor.schematic.addComponent({id:'T1',type:'transformer',position:{x:100,y:100},rotation:0});assert.deepEqual(editor.terminalPosition('T1:P1'),{x:45,y:70});assert.deepEqual(editor.terminalPosition('T1:S2'),{x:155,y:112});editor.schematic.getComponent('T1').rotation=90;assert.deepEqual(editor.terminalPosition('T1:P1'),{x:130,y:45});assert.deepEqual(editor.terminalPosition('T1:S2'),{x:88,y:155})});
