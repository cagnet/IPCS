...
export class Schematic{
 ...
 toJSON(){return {formatVersion:this.formatVersion,name:this.name,grid:this.grid,wireStyles:this.wireStyles,components:this.components,wires:this.wires,relations:this.components.filter(c=>c.type==='contact'&&c.controllerId).map(c=>({type:'coilControlsContact',from:c.controllerId,to:c.id}))};}
}
